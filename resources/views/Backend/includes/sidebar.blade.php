    ...
    <ul class="py-1 menu-inner">
        ...
        <li class="menu-item">
            ...
            <ul class="menu-sub">
                ...
                <li class="menu-item">
                    <a href="{{ route('admin.shipping-charge.index') }}" class="menu-link">
        ...
        <li class="menu-item">
            <a href="javascript:void(0);" class="menu-link menu-toggle">
                ...
                <div data-i18n="Account Settings">API Integration</div>
            </a>
            <ul class="menu-sub">
                <li class="menu-item">
                    <a href="{{ route('admin.mail-gateway.index') }}" class="menu-link">
                        <div data-i18n="Account">Mail Gateway</div>
                    </a>
                </li>
                <li class="menu-item">
                ...
                <li class="menu-item">
                    <a href="{{ route('admin.payment-gateway.index') }}" class="menu-link">
