        ...
        <div class="div-section">
            <table class="table-with-info">
                <tr>
                    ...
                    <td style="width: 25%;">
                        <strong>
                            <img src="{{ asset($generalsetting->dark_logo) }}" style="width:70%; margin-bottom:10px">
                        </strong>
                        <p>
            ...
            <div style="display: flex; flex-direction: row; justify-content: space-between;">
                <p>Order Date: {{ $order->created_at->format('d-m-Y') }} , Payment Method: {{ $payment->payment_method }}
                </p>
                <p>Source: Web</p>
